  ...
  return (
    ...
    <Box sx={{  backgroundColor:"white", padding:"20px"}} className="p-5 bod-3">
      ...
      <Box className="row">
              ...
              <Box className="flex-between">
                <Box className="card-number flex-vertical-center flex-fill">
                  <Box className="card-number-field flex-vertical-center flex-fill">
                    ...
                    maxLength={19}
                    onChange={handleCardNumberChange} placeholder="Card Number" className="form-control" id="cardNumber" name="cardNumber" data-bound="carddigits_mock" data-def="0000 0000 0000 0000" required />
                  </Box>
        ...
        <Box sx={{width:"50%", height:"400px"}} className="col-lg-4 col-md-12">
          <Box   className="purchase-section flex-fill flex-vertical">
          <Box>
            {isFlip ? (
              <Box sx={{width:"450px", height:"250px"  }}>
                <Box sx={{height:"210px"}} className="card-mockup flex-vertical">
                  <Box sx={{width:"100%", position:"absolute",height:"50px", backgroundColor:"black", top:"20px", right:"0px"}}></Box>
                  <Box sx={{display:"flex", textAlign:"center", alignItems:"center"}}>
                    <Box sx={{width:"250px", height:"50px", backgroundColor:"white", marginTop:"80px"}}></Box>
                    <Box sx={{background:"white", height:"50px", color:"black", textAlign:"center", marginTop:"80px"}}>{cvvNumber}</Box>
                  </Box>
              <Box>
              </Box>
            </Box>
