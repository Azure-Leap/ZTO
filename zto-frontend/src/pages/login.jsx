...
export default function SignInSide() {
  ...
  //   let switchCtn: HTMLElement | null = document.querySelector("#switch-cnt");
  //   let switchC1: HTMLElement | null = document.querySelector("#switch-c1");
  //   let switchC2: HTMLElement | null = document.querySelector("#switch-c2");
  //   let switchCircle: HTMLElement | null | [] =
  //     document.querySelectorAll(".switch__circle");
  //   let switchBtn: HTMLElement | null | [] =
  //     document.querySelectorAll(".switch-btn");
  //   let aContainer: HTMLElement | null = document.querySelector("#a-container");
  //   let bContainer: HTMLElement | null = document.querySelector("#b-container");
  //   let allButtons: HTMLElement | null | [HTMLElement] =
  //     document.querySelectorAll(".submit");

  //   let getButtons = (e: MouseEvent | TouchEvent) => e.preventDefault();

  //   let changeForm = (e: MouseEvent | TouchEvent) => {
  ...
  return <div className="main">{isSignIn ? containerA : containerB}</div>;
}
